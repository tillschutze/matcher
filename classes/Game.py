from classes.Board import MainBoard, Pattern
...
class Game:
    def __init__(self, screen, colors, dimension, player_count = 2):
        ...
        self.active_index = 0
        self.endTurnButton: ActionButton = ActionButton((50, 290, Constants.BUTTON_WIDTH, Constants.BUTTON_HEIGHT), "End Turn", self.end_turn)
        self.swapButton: ActionButton = ActionButton((Constants.ACTION_BUTTON_ORIGIN_X, 50, Constants.BUTTON_WIDTH, Constants.BUTTON_HEIGHT), "Swap Stones", self.start_swapping_stones)
        self.revealButton: ActionButton = ActionButton((Constants.ACTION_BUTTON_ORIGIN_X, 130, Constants.BUTTON_WIDTH, Constants.BUTTON_HEIGHT), "Reveal", self.start_reveal)
        self.resolveButton: ActionButton = ActionButton((Constants.ACTION_BUTTON_ORIGIN_X, 210, Constants.BUTTON_WIDTH, Constants.BUTTON_HEIGHT), "Resolve", self.start_resolving_card)
        self.cardSwapButton: ActionButton = ActionButton((Constants.ACTION_BUTTON_ORIGIN_X, 290, Constants.BUTTON_WIDTH, Constants.BUTTON_HEIGHT), "Swap Cards", self.start_swapping_card)
